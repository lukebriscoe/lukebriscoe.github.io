...
In my day job I’ve learned that building a team, especially one operating at high velocity with high stakes, is rarely as simple as assembling a team of competent professionals and leaving them to it. I've also learnt that it's wise to deeply understand and then be hard on the problem, rather than immediately on the individual. The same goes for the manager.

More often than not, the issue isn't competence (though yes, sometimes it is). The problems generally lie elsewhere — and my main message in this post is that in football, just like in software engineering, not everything is as it may seem…


## 🫥 The invisible game

From the stands, we don't see the training ground. We don't see the personal issues a player is carrying, the tactical instruction they’ve been given, or the quiet lack of confidence rippling through the dressing room after a few bad results (we've just hit 8 consecutive away defeats so I bet the staff coach journey home this weekend was fun).

It is exactly the same in engineering. However — when an engineering squad misses a deadline or a platform migration stalls, the first thing I ask is “what are the factors contributing to this?” before making knee-jerk reaction changes. In football however, we jumpimmediately to ask “why aren’t they working harder?” or “sack the manager!” after a few bad results (hi [Ryan Mason 👋](https://en.wikipedia.org/wiki/Ryan_Mason)).
...
- Do they actually believe in what they’re doing? (e.g. do they see the impact their efforts will lead to and do they influence/have autonomy over the methods to take them there?)
- Do they have a manager that inspires them to do better (e.g. are they learning and growing as a result of their leadership?)

## 🧘 Belief is a multiplier

West Brom can’t buy success by buying the best players and the best manager. We don’t have the money and we’re not a particularly exciting proposition for the top players in the game. In order to succeed we have to be greater than the sum of our parts — we have to have belief we can be better. Now I have no idea whether this team have belief or not as I’m not there behind the scenes, but in my job, I know that belief is a multiplier regardless of the company — and if we want to succeed, we've got a better chance with belief than without it.

When a team believes in the mission, they understand the outcomes they’re working towards, and they trust their manager has their back, they play with their heads up. They take calculated risks. They cover for each other’s mistakes rather than pointing fingers. They share ownership over problems.

When that belief is gone (e.g. when the dressing room is lost),  it doesn't matter how talented your senior engineers or your star players are. You get slow decision-making, a lack of cohesion, and a culture of "that's not my job." You get less optimal outcomes, and that's then when scruity turns to individuals. Trust me — I watched West Brom when they were managed by Tony Pulis and it was the worst football I've seen in my life, but I could suffer it as the outcomes (for most of his tenure) were good.

This is exactly the time we should be looking to deeply understand the contributors to the problem _before_ we call the players out.
