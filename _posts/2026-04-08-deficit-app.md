---
layout: page
title: "🏋 Building the Deficit app"
...
Alongside tracking my workouts consistently, I’ve also been half-heartedly tracking my calorie intake for the last 12 months. Boringly since the start of the year, I've been more deliberate with keeping a track of my progress as I go after some new fitness goals.<br>
<br>
...
### 🔜 What's next
<br>
I think I could easily over-engineer this so I’m desperately trying to avoid that — but the long-term vision is to be able to also integrate the other apps I’m using that feed in to this (Hevy, Fitness, Myfitnesspal) and package it up as an all-in-one offering. I think that’s at risk of being a pretty bloated product, but I’ll figure that out over time. 
